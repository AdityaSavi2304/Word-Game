...
function send()
{
    ...
    remove_charAt1=word.replace(word.charAt(1), "_");
    remove_charAt2=remove_charAt1.replace(word.charAt(Math.floor(word.length/2)), "_");
    remove_charAt3=remove_charAt2.replace(word.charAt(word.length-1), "_");
    console.log(remove_charAt3);

    line1="<h4 id='word_display'>Q. "+remove_charAt3+"</h4>";
